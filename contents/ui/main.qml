...
PlasmoidItem {
    ...
    MouseArea {
        ...
        onWheel: wheel => {
            ...
            if (Plasmoid.configuration.reverseScroll) {
                increment = -increment;
            }
    ...
    Grid {
        ...
        Repeater {
            ...
            PlasmaCore.ToolTipArea {
                ...
                visible: !plasmoid.configuration.showOnlyCurrentDesktop || active
